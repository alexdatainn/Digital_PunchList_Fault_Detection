...
def run(
    ...
    min_duration: float = 12  # hours
    if site in ["SENT", "SNDY", "MN", "BLH", "MAV"]:
        tags: List[str] = ["Temp.MB-Front"]
        ...
        for wtg in occurances:
            ...
            if dur >= min_duration:
                ...
                if len(stable_wtgs) > 1:
                    link_wtgs = [wtg + '-' + tags[0], stable_wtgs[0], stable_wtgs[1], wtg + '-' + power_tags[0], wtg + '-' + state_tags[0]]  # noqa E501
                elif len(stable_wtgs) > 0:
                    link_wtgs = [wtg + '-' + tags[0], stable_wtgs[0], wtg + '-' + power_tags[0], wtg + '-' + state_tags[0]]  # noqa E501
                else:
                    link_wtgs = [wtg + '-' + tags[0], wtg + '-' + power_tags[0], wtg + '-' + state_tags[0]]  # noqa E501
                    ...
                    ret.append(
                        {
                            ...
                            "evidence": [{
                                ...
                                "variable": f"Num Hours: {dur}, Rear MBearing Temp Diff from Median",  # noqa E501
