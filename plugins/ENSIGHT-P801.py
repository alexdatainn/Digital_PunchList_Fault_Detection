...
def run(
    ...
    for asset in ensight_events:
        if (
            asset["hcCode"] == "HC_01_01_38_01"
            # asset["alarmCategory"] == "Health"
            # and asset["alarmTypeEn"] == "Generator"
            # and asset["alarmDescriptionEn"] == "Temperature anomaly on generator stator coil"  # "Temperature anomaly on coil temperature of generator stator "  # noqa E501
        ):
