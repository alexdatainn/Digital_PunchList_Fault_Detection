...
def run(
    ...
    for asset in ensight_events:
        if (
            asset['hcCode'] == "HC_01_02_04_04"
            # asset["alarmCategory"] == "Health"
            # and asset["alarmTypeEn"] == "Gearbox"
            # and asset["alarmDescriptionEn"] == "Temperature anomaly on non-drive-end bearing and related components of gearbox high-speed shaft"  # noqa E501
        ):
